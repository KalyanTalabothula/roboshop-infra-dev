# 🔍 aws key terraform
# for windows nedd to use \\ double backslash, as well add pubkey. For Linu or MAC use / --> forward-slash. Now e file ni access chesi import chestumdhi AWS lopaliki
